...
# Embedding Model (used by document_handlers  ce_chart_handlers for RAG)
...
# This JSON_CE path is used by ce_chart_handlers.py for loading curriculum data for charts
...
MAX_RETRIES_CHART_GEN = 3 # Max attempts to fix chart code
